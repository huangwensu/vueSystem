    ...
    <el-card class="box-card cw-tree-table">
      <div class="app-container">
        ...
        <el-table
          ...
          <el-table-column prop="cname" label="权限名" width="120" align="center"></el-table-column>
          <el-table-column prop="ename" label="英文名" width="120" align="center"></el-table-column>
          ...
          <el-table-column prop="lastUpdateUserName" label="最后修改人" align="center"></el-table-column>
          <el-table-column label="最后修改时间" show-overflow-tooltip align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="created_at" label="操作" width="300" align="center">
            <template slot-scope="scope">
              ...
              <span class="options-action">
                <i class="el-icon-setting"></i><a href="javascript:;" @click.stop="configResource(scope.row)">设置资源</a>
              </span>
            </template>
          </el-table-column>
        </el-table>
...
<script>
import modelApi from '@/api/class/system/authority-manage'
...
export default {
  ...
  methods: {
    // 跳转到设置资源页面
    configResource(row) {
      vm.$router.push({ path: '/system/assign-resource', query: { id: row.id, name: row.name }})
    },
    ...
    g_search() {
      ...
      modelApi.getAuthorityManage(cUtil.mergePageProps(vm)).then(response => {
